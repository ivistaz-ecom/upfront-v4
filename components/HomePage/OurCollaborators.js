      ...
      <div className="bg-[#EFEFEF] pb-36 pt-10 mt-10">
        <div className="relative w-[70vw] mx-auto container">
          <div className="text-center">
            <p className="lg:text-5xl text-2xl secondary-title lg:my-4">
              Our Collaborators
            </p>
          </div>
          <Carousel
          ...
          >
            {OurCollaborators.map((item, index) => (
              <div
                key={index}
                className="flex flex-col justify-center items-center container mx-auto mt-10"
              >
                <Image
                  width={150}
                  height={200}
                  src={item.logoUrl}
                  alt="logo"
                  className="mx-auto shadow-sm h-20"
                />
              </div>
            ))}
          </Carousel>
